      ...
      >
        ...
        <div className="bg-white/[0.03] backdrop-blur-3xl p-8 sm:p-10 rounded-[3rem] border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
          ...
          <form onSubmit={handleRegister} className="space-y-5 relative">
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none">
                <User className="w-5 h-5 text-zinc-600 group-focus-within:text-amber-400 transition-colors" />
              </div>
              <input
                type="text"
          ...
          <div className="mt-10 text-center">
            ...
            >
              Zaten hesabın var mı? <span className="text-amber-500/80 group-hover:text-amber-400">Giriş yap</span>
            </button>
          </div>
        </div>
      </motion.div>
