        ...
        <AnimatePresence mode="wait">
          ...
          {step === 2 && (
            ...
            >
              ...
              <button
                disabled={formData.selectedCards.length < 3}
                onClick={nextStep}
                className="w-full py-5 rounded-2xl bg-gradient-to-r from-purple-600 to-purple-500 text-white font-bold shadow-2xl shadow-purple-900/20 disabled:opacity-20 disabled:grayscale flex items-center justify-center gap-3"
              >
            ...
            >
              <div className="relative">
                <motion.div
                  ...
                  className="w-48 h-48 rounded-full border-2 border-dashed border-purple-500/20"
                />
              ...
              <div className="space-y-4">
                <h2 className="text-3xl font-serif font-bold text-purple-50">Ritüel Başladı</h2>
                <p className="text-purple-200/60 leading-relaxed max-w-xs mx-auto">
                  Ahlas seçtiğin kartların enerjisini evrenin frekansıyla senkronize ediyor.
                </p>
              </div>

              <div className="w-full max-w-xs p-6 rounded-3xl bg-white/5 border border-white/10 space-y-6">
                <div className="flex items-center justify-between text-xs font-bold uppercase tracking-widest">
                  <span className="text-purple-200/40">Tahmini Süre</span>
                  <span className="text-purple-400">20 Dakika</span>
                </div>
                ...
                <div className="pt-4 border-t border-white/5 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm font-bold text-purple-400">{isSubscribed ? 'Ücretsiz' : `${price} Kredi`}</p>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (isSubscribed) {
                        // Check daily limit
                        const dailyLimit = config.subscriptionLimits.tarot;
                        const used = userProfile.subscription?.dailyReadingsUsed.tarot || 0;
                        ...
                        setTimeout(() => {
                          ...
                          onComplete({ ...formData, cards: formData.selectedCards });
                        }, 1500);
                        return;
                      }
              ...
              <button
                onClick={() => onComplete({ ...formData, cards: formData.selectedCards })}
                className="text-xs font-bold uppercase tracking-[0.3em] text-purple-200/40 hover:text-purple-400 transition-colors"
              >
                Normal Sırada Bekle
              </button>
            </motion.div>
