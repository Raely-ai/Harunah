          ...
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-2.5 pt-2">
              <div className="p-3.5 bg-black/[0.02] border border-black/5 rounded-2xl space-y-0.5">
                ...
                <p className="text-xs font-bold text-body">{user.social?.lookingFor || "Ruh Eşi"}</p>
              </div>
              <div className="p-3.5 bg-black/[0.02] border border-black/5 rounded-2xl space-y-0.5">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 pt-10 bg-gradient-to-t from-[#F6F4F8] via-[#F6F4F8]/95 to-transparent z-40">
        <div className="max-w-md mx-auto grid grid-cols-2 gap-4">
          ...
          <button 
            ...
            className={`flex items-center justify-center gap-3 py-4.5 bg-black/5 backdrop-blur-xl text-heading rounded-[2rem] font-bold text-base border border-black/5 hover:bg-black/10 transition-all active:scale-[0.98] transition-transform duration-150 ${isProcessing ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
